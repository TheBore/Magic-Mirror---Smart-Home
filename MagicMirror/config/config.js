...
let config = {
	...
	modules: [
		...
		//},
		{
  			module: "MMM-SPS30Display",
  			position: "top_left", // or any position you prefer
  			config: {
    			wsUrl: "ws://localhost:8069" // or use your Pi's IP if needed
  			}
		},
		{
     	    module: "MMM-DHT20Display",
            position: "bottom_left", // or any position you prefer
            config: {
            	wsUrl: "ws://localhost:8070" // or use your Pi's IP if needed
        	}
        },
		{
            module: "MMM-SGP30Display",
